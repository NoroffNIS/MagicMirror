...
Module.register("MMM-Calendar", {
	...
	start: function () {
		...
		for (var c in this.config.calendars) {
			...
			this.addCalendar(calendar.url, calendar.auth, calendarConfig, calendar.campus);
		}
	...
	getDom: function () {
		...
		for (var e in events) {
			...
			locationWrapper.innerHTML = this.titleTransform(event.location) + repeatingCountTitle;
			locationWrapper.className = "time bright";
	 ...
	 */
	addCalendar: function (url, auth, calendarConfig, campus) {
